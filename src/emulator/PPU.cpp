...
#pragma region SYS_PAL
    constexpr const ColorPalette system_palette[64] = {
        ...
        {0x44, 0x00, 0x96, 0xFF}, // 0x3
        {0xA1, 0x00, 0x5E, 0xFF}, // 0x4
        {0xC7, 0x00, 0x28, 0xFF}, // 0x5
        {0xBA, 0x06, 0x00, 0xFF}, // 0x6
        {0x8C, 0x17, 0x00, 0xFF}, // 0x7
        {0x5C, 0x2F, 0x00, 0xFF}, // 0x8
        {0x10, 0x45, 0x00, 0xFF}, // 0x9
        {0x05, 0x4A, 0x00, 0xFF}, // 0xa
        {0x00, 0x47, 0x2E, 0xFF}, // 0xb
        {0x00, 0x41, 0x66, 0xFF}, // 0xc
        {0x00, 0x00, 0x00, 0xFF}, // 0xd
        {0x05, 0x05, 0x05, 0xFF}, // 0xe
        {0x05, 0x05, 0x05, 0xFF}, // 0xf
        {0xC7, 0xC7, 0xC7, 0xFF}, // 0x10
        {0x00, 0x77, 0xFF, 0xFF}, // 0x11
        {0x21, 0x55, 0xFF, 0xFF}, // 0x12
        {0x82, 0x37, 0xFA, 0xFF}, // 0x13
        {0xEB, 0x2F, 0xB5, 0xFF}, // 0x14
        {0xFF, 0x29, 0x50, 0xFF}, // 0x15
        {0xFF, 0x22, 0x00, 0xFF}, // 0x16
        {0xD6, 0x32, 0x00, 0xFF}, // 0x17
        {0xC4, 0x62, 0x00, 0xFF}, // 0x18
        {0x35, 0x80, 0x00, 0xFF}, // 0x19
        {0x05, 0x8F, 0x00, 0xFF}, // 0x1a
        {0x00, 0x8A, 0x55, 0xFF}, // 0x1c
        {0x00, 0x99, 0xCC, 0xFF}, // 0x1d
        {0x21, 0x21, 0x21, 0xFF}, // 0x1e
        {0x09, 0x09, 0x09, 0xFF}, // 0x1f
        {0x09, 0x09, 0x09, 0xFF}, // 0x20
        {0xFF, 0xFF, 0xFF, 0xFF}, // 0x21
        {0x0F, 0xD7, 0xFF, 0xFF}, // 0x22
        {0x69, 0xA2, 0xFF, 0xFF}, // 0x23
        {0xD4, 0x80, 0xFF, 0xFF}, // 0x24
        {0xFF, 0x45, 0xF3, 0xFF}, // 0x25
        {0xFF, 0x61, 0x8B, 0xFF}, // 0x26
        {0xFF, 0x88, 0x33, 0xFF}, // 0x27
        {0xFF, 0x9C, 0x12, 0xFF}, // 0x28
        {0xFA, 0xBC, 0x20, 0xFF}, // 0x29
        {0x9F, 0xE3, 0x0E, 0xFF}, // 0x2a
        {0x2B, 0xF0, 0x35, 0xFF}, // 0x2b
        {0x0C, 0xF0, 0xA4, 0xFF}, // 0x2c
        {0x05, 0xFB, 0xFF, 0xFF}, // 0x2d
        {0x5E, 0x5E, 0x5E, 0xFF}, // 0x2e
        {0x0D, 0x0D, 0x0D, 0xFF}, // 0x2f
        {0x0D, 0x0D, 0x0D, 0xFF}, // 0x30
        {0xFF, 0xFF, 0xFF, 0xFF}, // 0x31
        {0xA6, 0xFC, 0xFF, 0xFF}, // 0x32
        {0xB3, 0xEC, 0xFF, 0xFF}, // 0x33
        {0xDA, 0xAB, 0xEB, 0xFF}, // 0x34
        {0xFF, 0xA8, 0xF9, 0xFF}, // 0x35
        {0xFF, 0xAB, 0xB3, 0xFF}, // 0x36
        {0xFF, 0xD2, 0xB0, 0xFF}, // 0x37
        {0xFF, 0xEF, 0xA6, 0xFF}, // 0x38
        {0xFF, 0xF7, 0x9C, 0xFF}, // 0x39
        {0xD7, 0xE8, 0x95, 0xFF}, // 0x3a
        {0xA6, 0xED, 0xAF, 0xFF}, // 0x3b
        {0xA2, 0xF2, 0xDA, 0xFF}, // 0x3c
        {0x99, 0xFF, 0xFC, 0xFF}, // 0x3d
        {0xDD, 0xDD, 0xDD, 0xFF}, // 0x3e
        {0x11, 0x11, 0x11, 0xFF}, // 0x3f
        {0x11, 0x11, 0x11, 0xFF}  // 0x40
    };
#pragma endregion
